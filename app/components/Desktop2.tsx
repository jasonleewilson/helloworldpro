...
const Desktop2 = () => (
  <>
    <div className='h-96 my-8 flex content-end sm:flex-wrap md:flex-nowrap items-start gap-0 px-8 mx-8 bg-white bg-[url("app/assets/images/burger1.png")] bg-no-repeat bg-size-[auto_700px] bg-position-[center_right_-10rem] rounded-2xl'>
    ...
    <div className='xs:h-auto h-96 my-8 flex flex-wrap gap-0 mx-8 bg-white rounded-2xl'>
      ...
      <div className='h-96 order-1 md:order-2 w-full md:w-2/3 bg-[url("app/assets/images/burger1.png")] bg-no-repeat bg-size-[auto_700px] bg-position-[center_center_-10rem] md:bg-position-[center_right_-10rem] rounded-none  md:rounded-2xl'></div>
    </div>
  </>
);
